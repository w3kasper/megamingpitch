...
const Navbar = () => {
  return (
    <div className="flex flex-row w-full text-gray-200 z-10 fixed bg-neutral-900">
      <div className="w-[225px] h-20">
        <div className="mt-[25px] pl-10">
          <img src={logo} alt="Logo" />
        </div>
      </div>
      <div className="ml-8 w-[160px] h-10 rounded self-center  bg-neutral-900 outline outline-1 outline-violet-800/[.4]">
        <button>
          <div className="flex">
      ...
      <div className="absolute inset-y-0 right-0 ml-8 w-[150px] h-10 rounded bg-neutral-900 mt-[20px] mr-6 outline outline-2 outline-pink-600">
        <div className="flex">
